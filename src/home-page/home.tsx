...
export function Home() {
    return (
        ...
        <div className="absolute flex text-[#2B2823] gap-5 flex-col font-semibold text-7xl z-50 justify-center items-center bg-white/60 h-3/8 w-3/7 rounded-md fonteLogo">
        <p>CALCULADORA</p>
        <p>DE</p>
        <p>PRESCRIÇÃO</p>
        </div>
